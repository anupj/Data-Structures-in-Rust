/// Takes in an array as an argument. The function
/// should return a 2D array where each subarray
/// represents one of the possible subsets of the
/// array.
///
/// The elements within the subsets and the
/// subsets themselves may be returned in any order.
///
